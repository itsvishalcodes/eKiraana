...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post dealers_url, params: { dealer: { email: @dealer.email, password: @dealer.password } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { email: @dealer.email, password: @dealer.password } }
